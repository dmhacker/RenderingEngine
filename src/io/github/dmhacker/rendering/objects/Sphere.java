...
public class Sphere implements Object3d {
	...
	private void calculateAABB() {
		...
		boundingVertices.add(center.add(new Vec3d(-radius, 0, 0)));
		boundingVertices.add(center.add(new Vec3d(radius, 0, 0)));
		boundingVertices.add(center.add(new Vec3d(0, -radius, 0)));
		boundingVertices.add(center.add(new Vec3d(0, radius, 0)));
		boundingVertices.add(center.add(new Vec3d(0, 0, -radius)));
		boundingVertices.add(center.add(new Vec3d(0, 0, radius)));
